...
def main():
    ds = load_npz_dataset("data/compendium/non_western_40k.npz")
    ...
    Path("outputs/ablations_realistic").mkdir(parents=True, exist_ok=True)
    with open("outputs/ablations_realistic/results.json", "w") as f:
